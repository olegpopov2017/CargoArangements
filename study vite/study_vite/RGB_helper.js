...
export function create_RGB_axes_helper_with_symbols(width_x,height_y,depth_z){
    ...
    //Create green axe with text "Y"
        ...
        loader_y.load( '/node_modules/three/examples/fonts/optimer_regular.typeface.json', function ( font ) {
            const text_geometry = new TextGeometry( 'Y (height)', {
                font: font,
                size: 80,
                depth: 5,
                curveSegments: 12,
    ...
    //Create red axe with text "Z"
        ...
        loader_z.load( '/node_modules/three/examples/fonts/optimer_regular.typeface.json', function ( font ) {
            const text_geometry = new TextGeometry( 'Z (depth)', {
                font: font,
                size: 80,
                depth: 5,
                curveSegments: 12,
