...
import {
  cargo_area_adding,
  resize_renderer,
  create_cargo_after_input_data_and_adding_to_scene,
} from './functions.js'
import {
  placement_cargo_according_to_algorithm_on_local_server,
  present_object_parameters,
  placement_cargo_according_to_algorithm_on_internet_server,
} from './NEW_functions.js'
import { import_from_excel, export_to_excel } from './excel.js'
import { testfunc } from './Table_of_cargo_parameters.js'
...
// button45.addEventListener('click',present_object_parameters)
let button45 = document.querySelector('#button45')
button45.addEventListener(
  'click',
  () => (
    create_cargo_after_input_data_and_adding_to_scene(),
    present_object_parameters()
...
button43.addEventListener(
  'click',
  () => (cargo_group.clear(), present_object_parameters())
)
